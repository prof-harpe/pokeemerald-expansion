...
const u32 gTrainerFrontPic_OldCoupleMM[] = INCBIN_U32("graphics/trainers/front_pics/old_couple_mm.4bpp.lz");
const u16 gTrainerPalette_OldCoupleMM[] = INCBIN_U16("graphics/trainers/front_pics/old_couple_mm.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_OLD_COUPLE_MM, gTrainerFrontPic_OldCoupleMM, gTrainerPalette_OldCoupleMM),
};
