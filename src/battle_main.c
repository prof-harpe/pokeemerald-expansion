...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("Hiker"), 10, BALL_DUSK },
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("Cooltrainer"), 12, BALL_GREAT },
    ...
    [TRAINER_CLASS_LADY] = { _("Lady"), 50, BALL_LOVE },
    [TRAINER_CLASS_BEAUTY] = { _("Beauty"), 20 },
    [TRAINER_CLASS_RICH_BOY] = { _("Rich Boy"), 50, BALL_ULTRA },
    ...
    [TRAINER_CLASS_WINSTRATE] = { _("Winstrate"), 10, BALL_SPORT },
    ...
    [TRAINER_CLASS_DRAGON_TAMER] = { _("Dragon Tamer"), 12, BALL_GREAT },
    ...
    [TRAINER_CLASS_COOLTRAINER_2] = { _("Cooltrainer"), 5, BALL_GREAT },
    ...
    [TRAINER_CLASS_SALON_MAIDEN] = { _("Salon Maiden"), BALL_MASTER },
    [TRAINER_CLASS_DOME_ACE] = { _("Dome Ace"), BALL_MASTER },
    [TRAINER_CLASS_PALACE_MAVEN] = { _("Palace Maven"), BALL_MASTER },
    [TRAINER_CLASS_ARENA_TYCOON] = { _("Arena Tycoon"), BALL_MASTER },
    [TRAINER_CLASS_FACTORY_HEAD] = { _("Factory Head") },
    [TRAINER_CLASS_PIKE_QUEEN] = { _("Pike Queen"), BALL_MASTER },
    [TRAINER_CLASS_PYRAMID_KING] = { _("Pyramid King"), BALL_MASTER },
